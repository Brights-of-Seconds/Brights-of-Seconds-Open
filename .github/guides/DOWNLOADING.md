...
```
docker run -d -p <your port>:1337 -v /path/to/your/config:/tgstation/config -v /path/to/your/data:/Brights-of-Seconds/data Brights-of-Seconds/Brights-of-Seconds <dream daemon options i.e. -public or -params>
```
