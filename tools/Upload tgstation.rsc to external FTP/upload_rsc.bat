@REM Script to easily upload Brights-of-Seconds.rsc to your FTP-server so that clients download it from an
...
@REM Replace FOLDER/FOLDER with the folder on the FTP server where you want to store Brights-of-Seconds.rsc, for example: cd www/rsc
@REM Replace FTP.DOMAIN.COM with the IP-address or domain name of your FTP server
@REM Add the URL to the location of Brights-of-Seconds.rsc on your webserver into data\external_rsc_urls.txt
@REM
@echo off
...
echo put ..\..\Brights-of-Seconds.rsc>> ftpcmd.dat
